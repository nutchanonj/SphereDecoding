...
HD_PWD='D:/Study/Digital Communication IC Design/Non/SphereDecoding/xilinx/MIMO_detector/MIMO_detector.runs/synth_1_copy_3'
cd "$HD_PWD"
...
EAStep vivado -log MIMO_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MIMO_detector.tcl
