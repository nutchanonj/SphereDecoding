...
for p = 1:H_num
    ...
    R_shift_11_real = dec2hex(real(R_shift(1,1)),5);
    R_shift_11_imag = dec2hex(imag(R_shift(1,1)),5);
    R_shift_12_real = dec2hex(real(R_shift(1,2)),5);
    R_shift_12_imag = dec2hex(imag(R_shift(1,2)),5);
    R_shift_13_real = dec2hex(real(R_shift(1,3)),5);
    R_shift_13_imag = dec2hex(imag(R_shift(1,3)),5);
    R_shift_14_real = dec2hex(real(R_shift(1,4)),5);
    R_shift_14_imag = dec2hex(imag(R_shift(1,4)),5);
    R_shift_22_real = dec2hex(real(R_shift(2,2)),5);
    R_shift_22_imag = dec2hex(imag(R_shift(2,2)),5);
    R_shift_23_real = dec2hex(real(R_shift(2,3)),5);
    R_shift_23_imag = dec2hex(imag(R_shift(2,3)),5);
    R_shift_24_real = dec2hex(real(R_shift(2,4)),5);
    R_shift_24_imag = dec2hex(imag(R_shift(2,4)),5);
    R_shift_33_real = dec2hex(real(R_shift(3,3)),5);
    R_shift_33_imag = dec2hex(imag(R_shift(3,3)),5);
    R_shift_34_real = dec2hex(real(R_shift(3,4)),5);
    R_shift_34_imag = dec2hex(imag(R_shift(3,4)),5);
    R_shift_44_real = dec2hex(real(R_shift(4,4)),5);
    R_shift_44_imag = dec2hex(imag(R_shift(4,4)),5);
    empty = dec2hex(0,5);
    ...
    for q = 1:11
        ...
        In_0_real = dec2hex(real(y_received_R_shift(1)),5);
        In_0_imag = dec2hex(imag(y_received_R_shift(1)),5);
        In_1_real = dec2hex(real(y_received_R_shift(2)),5);
        In_1_imag = dec2hex(imag(y_received_R_shift(2)),5);
        In_2_real = dec2hex(real(y_received_R_shift(3)),5);
        In_2_imag = dec2hex(imag(y_received_R_shift(3)),5);
        In_3_real = dec2hex(real(y_received_R_shift(4)),5);
        In_3_imag = dec2hex(imag(y_received_R_shift(4)),5);
...
bit_received_verilog = zeros(1,(12*11*H_num));
...
BER_verilog = sum(abs( bit_received_verilog - bit_sent ))/(12*11*H_num);
disp(BER_verilog)
